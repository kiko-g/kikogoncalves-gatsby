  ...
  return (
    <div className="container">
      ...
      <div className="relative mx-auto w-full max-w-lg">
        ...
        <div className="animate-blob animation-delay-2000 absolute -top-8 -right-4 h-72 w-72 rounded-full bg-secondary opacity-70 mix-blend-multiply blur-xl filter"></div>
        <div className="relative m-8 space-y-4">
          ...
          <div className="flex items-center justify-between space-x-8 rounded-lg bg-white p-5">
            ...
            <div>
              <div className="h-6 w-16 rounded-lg bg-secondary md:w-20"></div>
            </div>
          </div>
        </div>
      </div>
