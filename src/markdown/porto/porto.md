...
Our product is a platform where users can interact with each other by discussing any technology-related issues, creating an environment with centralized information. So whether you're having trouble with an application or can't seem to install a VPN on your computer, Tech Council is the place to look for answers.

The core elements of the platform are the questions (asked by users), which are associated with a group of tags, to help divide the information into relevant categories. Users can interact with the questions through answers, comments, and votes. They can also follow tags, save questions, search for contents (questions, tags, and users) and report what they don't find appropriate. To handle these situations, we implemented a moderator area, where moderators can manage the content on the platform.

This artefact results from implementing the platform designed previously, using PHP and Laravel for generating dynamic web pages and PostgreSQL as a database management system.
...
As described in the user stories and the actors diagram, the Admin is not a User. This way, the Admin does not authenticate and interact with the platform. Instead, there are three commands available with **php artisan**:
...
| Test          | Result | Link                                                                                                        |
| ------------- | ------ | ----------------------------------------------------------------------------------------------------------- |
| Accessibility | 16/18  | [docs/accessibility](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/acessibilidade2132.pdf) |
| Usability     | 24/28  | [docs/usability](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/usabilidade2132.pdf)        |
...
| Type | Item                  | Errors | Warnings | Link                                                                                                                                         |
| ---- | --------------------- | :----: | :------: | :------------------------------------------------------------------------------------------------------------------------------------------- |
| HTML | About page            |   0    |    0     | [html/about](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/html/about_html_validation.pdf)                       |
| HTML | Ask page              |   0    |    1     | [html/ask](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/html/ask_html_validation.pdf)                           |
| HTML | FAQ page              |   0    |    0     | [html/faq](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/html/faq_html_validation.pdf)                           |
| HTML | Main page             |   0    |    2     | [html/main](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/html/main_html_validation.pdf)                         |
| HTML | Moderator page        |   0    |    2     | [html/moderator](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/html/moderator_html_validation.pdf)               |
| HTML | Profile page          |   0    |    2     | [html/profile](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/html/profile_html_validation.pdf)                   |
| HTML | Profile Settings page |   0    |    0     | [html/profile-settings](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/html/profile-settings_html_validation.pdf) |
| HTML | Search page           |   0    |    1     | [html/search](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/html/search_html_validation.pdf)                     |
| HTML | Tag page              |   0    |    2     | [html/tag](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/html/tag_html_validation.pdf)                           |
| CSS  | aside.css             |   0    |    0     | [css/about](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/about_css_validation.pdf)                          |
| CSS  | ask.css               |   0    |    0     | [css/ask](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/ask_css_validation.pdf)                              |
| CSS  | bootstrap.css         |   0    |    1     | [css/bootstrap](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/bootstrap_css_validation.pdf)                  |
| CSS  | colors.css            |   0    |    2     | [css/colors](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/colors_css_validation.pdf)                        |
| CSS  | fonts.css             |   0    |    0     | [css/fonts](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/fonts_css_validation.pdf)                          |
| CSS  | footer.css            |   0    |    0     | [css/footer](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/footer_css_validation.pdf)                        |
| CSS  | generic.css           |   0    |    0     | [css/generic](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/generic_css_validation.pdf)                      |
| CSS  | login.css             |   0    |    0     | [css/login](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/login_css_validation.pdf)                          |
| CSS  | profile.css           |   0    |    0     | [css/profile](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/profile_css_validation.pdf)                      |
| CSS  | question.css          |   0    |    0     | [css/question](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/question_css_validation.pdf)                    |
| CSS  | question-page.css     |   0    |    0     | [css/question-page](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/question-page_css_validation.pdf)          |
| CSS  | search.css            |   0    |    2     | [css/search](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/search_css_validation.pdf)                        |
| CSS  | style.css             |   0    |    0     | [css/about](https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/validation/css/style_css_validation.pdf)                          |
...
- The amount of warnings we indicated in the tables above is for the type of warning and not the exact counter of warnings. For example, the colours CSS file has 126 warnings, but 125 are the interpreter not detecting variables defined in the `:root` element (`--varname` is an unknown vendor extension).
...
| Removed US705: Flag posts             | Initially, we wanted to give expert users the ability to report content but have it be more meaningful than reports coming from regular users, but concluded that this is not a high priority feature, since when a report is issued, the moderator who will solve it can see the expert badge |

After receiving feedback on the EAP artefact, we also updated some of the endpoints described in A7.
...
| US114         | View if post was edited   | M03    | Medium   | **Francisco Gonçalves**                         | 100%  |
...
This artefact results from the presentation of the developed platform and includes a brief presentation of the product, a promotion video and the slides used during the presentation.
...
URL to the product: http://lbaw2132.lbaw-prod.fe.up.pt
Slides used during the presentation: https://git.fe.up.pt/lbaw/lbaw2021/lbaw2132/-/blob/master/docs/demo/demo.pdf
...
Every group member actively participated in every artefact/step of the project.
